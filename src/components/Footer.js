        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div className="mt-8 xl:mt-0">
              ...
              <p className="mt-4 text-base text-white-300">
                Agenda tu cita para más información y puedas presenciar nuestras
                instalaciones.
              </p>
            </div>
          </div>
          <div className="mt-8 border-t border-white-700 pt-8 md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              <div href="#" className="text-black hover:text-white">
            ...
            <p className="mt-8 text-base text-white-400 md:mt-0 md:order-1">
